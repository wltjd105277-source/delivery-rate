...
(() => {
  ...
  const COLS = ["발주일자","발주번호","상품명","모델명","발주수량","실제출고량","미출고수량","미출고 금액","미출고사유","비고"];
  const HEADER_SYNONYMS = {
    "발주일자":"발주일자","발주일":"발주일자","주문일자":"발주일자",
    "발주번호":"발주번호","발주ID":"발주번호","주문번호":"발주번호","발주 번호":"발주번호",
    "상품명":"상품명","옵션명":"상품명","상품 명":"상품명",
    "모델명":"모델명","모델 명":"모델명","모델":"모델명","SKU":"모델명","sku":"모델명",
    "발주수량":"발주수량","주문수량":"발주수량","발주 수량":"발주수량",
    "실제출고량":"실제출고량","출고수량":"실제출고량","출고량":"실제출고량","실 출고":"실제출고량","실출고":"실제출고량","실출고량":"실제출고량",
    "미출고수량":"미출고수량","미출고 수량":"미출고수량","결품수량":"미출고수량",
    "미출고 금액":"미출고 금액","미출고금액":"미출고 금액","결품금액":"미출고 금액",
    "미출고사유":"미출고사유","미출고 사유":"미출고사유","결품사유":"미출고사유","사유":"미출고사유",
    "비고":"비고","메모":"비고","코멘트":"비고"
  };
  ...
  function rowsFromSheet(ws, sheetName, fileName){
    ...
    for(let r=headerIdx+1;r<aoa.length;r++){
      ...
      out.push({
        ...
        발주수량:  num(idx["발주수량"]>=0 ? row[idx["발주수량"]] : 0),
        실제출고량: num(idx["실제출고량"]>=0 ? row[idx["실제출고량"]] : 0),
        미출고수량: num(idx["미출고수량"]>=0 ? row[idx["미출고수량"]] : 0),
        "미출고 금액": num(idx["미출고 금액"]>=0 ? row[idx["미출고 금액"]] : 0),
        미출고사유: idx["미출고사유"]>=0 && row[idx["미출고사유"]]!=null ? String(row[idx["미출고사유"]]).trim() : "",
  ...
  /* ---------- 이벤트 바인딩 ---------- */
  function bind(){
    $$("#main, header.top, nav.tabs"); // no-op
